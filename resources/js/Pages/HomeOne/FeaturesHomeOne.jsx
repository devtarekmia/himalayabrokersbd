...
import thumb from '@images/features-thumb-1.png';
import shapeSix from '@images/shape/shape-6.png';
import shapeSeven from '@images/shape/shape-7.png';
import shapeEight from '@images/shape/shape-8.png';
                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-9">
                        <div className="tab-content" id="v-pills-tabContent">
                            <div
                                className={`${tab === 'setting' ? 'show active' : ''
                                    } tab-pane fade`}
                                id="v-pills-home"
                                role="tabpanel"
